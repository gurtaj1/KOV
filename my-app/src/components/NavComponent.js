			...
			<div className="navNarrow">
				<i className="fa fa-bars" onClick={this.burgerToggle}></i>
					<div className="narrowLinks">
						...
						<Link to='/home' className="homePage" onClick={this.burgerToggle}>Home</Link>
						<Link to="/kits" className="kitsPage" onClick={this.burgerToggle}>Kits</Link>
						<Link to="/tanks" className="tanksPage" onClick={this.burgerToggle}>Tanks</Link>
						<Link to="/coils" className="coilsPage" onClick={this.burgerToggle}>Coils</Link>
						<Link to="/eliquids" className="eLiquidsPage" onClick={this.burgerToggle}>E-Liquids</Link>
						<Link to="/batteries" className="batteriesPage" onClick={this.burgerToggle}>Batteries</Link>
					</div>
			</div>
		</nav>
		</div>
